...
/*----------------------------------------------------------------------------*/
/*                                                                 			  	*/
/* Filename		: DB_IHM_Setting_Adjust_Psimv_Mode_PSupport.c    	       		*/
/*                                                           				  		*/
/*----------------------------------------------------------------------------*/
...
/*%C        of the P Support setting in the Psimv mode     							*/
/*                                                            				  		*/
...
#include "DB_IHM_Setting_Adjust_Psimv_Mode_PSupport.h"
...
UWORD16 DB_IHM_Setting_Adjust_Psimv_Mode_PSupport(UWORD16 *Value,
																  UWORD16 Id)
{
