...
/*----------------------------------------------------------------------------*/
/*                                                                 			  	*/
/* Filename		: DB_IHM_Write_Adjust_Psimv_Mode_High_Vti.c 	          		   */
/*                                                           				  		*/
/*----------------------------------------------------------------------------*/
...
/*%C        High_Vti setting in the Psimv mode         								*/
/*                                                            				  		*/
...
UWORD16 DB_IHM_Write_Adjust_Psimv_Mode_High_Vti(UWORD16 *Value)
{
/*%C Id values recuperation from adjust base in psv mode */
   UWORD16 Adjust_Low_Vti = EEP_DB_PSIMV_Adjust[ADJUST_LOW_VTI_U16];
   UWORD16 Low_Vti_No_Select = EEP_DB_PSIMV_Adjust[LOW_VTI_NO_SELECT_U16];
