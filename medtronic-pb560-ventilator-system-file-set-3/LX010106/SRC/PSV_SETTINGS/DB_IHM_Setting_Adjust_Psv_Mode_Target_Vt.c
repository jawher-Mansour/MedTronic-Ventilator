...
/*----------------------------------------------------------------------------*/
/*                                                                 			  	*/
/* Filename		: DB_IHM_Setting_Adjust_Psv_Mode_Target_Vt.c      	       		*/
/*                                                           				  		*/
/*----------------------------------------------------------------------------*/
...
UWORD16 DB_IHM_Setting_Adjust_Psv_Mode_Target_Vt(UWORD16 *Value,
																UWORD16 Id)
{
...
/*%C If "no select flag" activated => "no select flag" cancelled */
	else if (EEP_DB_PSV_Adjust[TARGET_VT_SELECT_U16] == FALSE)
	{
/*%C  Flag writing by DB_WriteDataInEepAndRam function call 	*/
		DB_WriteDataInEepAndRam(&EEP_DB_PSV_Adjust[TARGET_VT_SELECT_U16],
										TRUE);
