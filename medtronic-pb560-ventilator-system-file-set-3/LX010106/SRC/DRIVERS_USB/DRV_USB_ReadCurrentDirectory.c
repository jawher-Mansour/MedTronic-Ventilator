...
/*----------------------------------------------------------------------------*/
/*                                                                            */
/* Filename  : DRV_USB_ReadCurrentDirectory.c 											*/
/*																										*/
/*----------------------------------------------------------------------------*/
...
#include "DRV_USB_ReadCurrentDirectory.h"

/******************************************************************************/
/*                   			FUNCTION BODY                    					*/
/******************************************************************************/
void DRV_USB_ReadCurrentDirectory(UBYTE MsNb , UBYTE FirstOrNext)
{
...
/******************************************************************************/
	...
	PEC_Emission[2] = CMD_READ_CURRENT_DIRECTORY ;
	PEC_Emission[3] = MsNb;

	/*%C Next Byte is the parameter															*/
	PEC_Emission[4] =	FirstOrNext ;

	/*%C Next byte is the CRC																	*/
	PEC_Emission[5] = (UBYTE) (CheckSum >> 8) ;
	PEC_Emission[6] = (UBYTE) CheckSum ;
