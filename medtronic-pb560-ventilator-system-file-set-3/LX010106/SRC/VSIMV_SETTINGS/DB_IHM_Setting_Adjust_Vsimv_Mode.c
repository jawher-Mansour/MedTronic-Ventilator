...
/*----------------------------------------------------------------------------*/
/*                                                                 			  	*/
/* Filename		: DB_IHM_Setting_Adjust_Vsimv_Mode.c 	 	                 		*/
/*                                                           				  		*/
/*----------------------------------------------------------------------------*/
...
/*%C        settings in DataBase for the Vsimv mode: 									*/
/*                                                            				  		*/
/******************************************************************************/
...
UWORD16 DB_IHM_Setting_Adjust_Vsimv_Mode(UWORD16 *Value, UWORD16 Id)
{
...
/*%C  Vol control limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Vol_Control(Value,
			                                                               Id);
			break;
		}
...
/*%C  Ti control limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Ti_Control(Value,
			                                                              Id);
			break;
		}
...
/*%C  Control R limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Control_R(Value,
			                                                             Id);
			break;
		}
...
/*%C  P support limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_P_Support(Value,
			                                                             Id);
			break;
		}
...
/*%C  Peep limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Peep(Value,
			                                                        Id);
			break;
		}
...
/*%C  Apnea limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Apnea_Time(Value,
			                                                             Id);
			break;
		}
...
/*%C  Insp sens limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Insp_Sens(Value,
			                                                             Id);
			break;
		}
/*%C  Exh sens limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Exh_Sens(Value,
			                                                             Id);
			break;
		}
/*%C  Exh sens limits check function call */
...
/*%C     Exh sens writing function call  */
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Exh_Sens_Neg(Value,
			                                                  		         Id);
			break;
		}
...
/*%C  Low pip limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Low_Pip(Value,
			                                                           Id);
			break;
		}
...
/*%C  High pip limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_High_Pip(Value,
			                                                            Id);
			break;
		}
...
/*%C  Low vti limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Low_Vti(Value,
			                                                           Id);
			break;
		}
...
/*%C  High vti limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_High_Vti(Value,
			                                                            Id);
			break;
		}
...
/*%C  Low vte limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Low_Vte(Value,
			                                                           Id);
			break;
		}
		...
		{
/*%C     Low vte limits check function call */
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_High_Vte(Value,
																						  Id); 
...
/*%C     Rise Time limits check function call */
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Rise_Time(Value,
																						  Id); 
...
//		{
//			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_Low_Vm(Value,
//			                                                          Id);
//			break;
//		}
//
...
//		{
//			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_High_Vm(Value,
//			                                                           Id);
//			break;
//		}
...
/*%C  High R limits check function call */
		...
		{
			Function_Result = DB_IHM_Setting_Adjust_Vsimv_Mode_High_R(Value,
			                                                          Id);
			break;
		}
