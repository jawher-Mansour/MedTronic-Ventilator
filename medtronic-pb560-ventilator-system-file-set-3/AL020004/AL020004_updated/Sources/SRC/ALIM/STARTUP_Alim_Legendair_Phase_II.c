...
void _entry (void);
void _startup (void);
//void _remap_entry_vector (void);
//void _remap_hight_interrupt_vector (void);
//void _remap_low_interrupt_vector (void);
...
/* Le remaping est effectué par bootload.asm

#pragma code _remap_entry_vector_scn=0x000000
void _remap_entry_vector (void)
{
	_asm goto _entry _endasm
}


#pragma code _remap_hight_interrupt_vector_scn=0x000008
void _remap_hight_interrupt_vector (void)
{
	_asm goto INTERRUPT_HighPriority _endasm
}

#pragma code _remap_low_interrupt_vector_scn=0x000018
void _remap_low_interrupt_vector (void)
{
	_asm goto INTERRUPT_LowPriority _endasm
}
*/
